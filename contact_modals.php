<div id="addContactModal" class="fixed inset-0 z-[150] hidden">
    ...
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg p-4">
        <form action="contact_actions.php" method="POST" class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-100 animate-in fade-in zoom-in duration-200">
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="notes" rows="3" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 outline-none focus:ring-2 focus:ring-indigo-500" placeholder="Additional details..."></textarea>
                </div>
            </div>
